<script>
    ...
    $: leftPosition = isSidebarVisible ? '204px' : '10px';
</script>
...
<aside id="default-sidebar"
       class="sidebar fixed top-0 left-0 z-40 h-screen bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 {isSidebarVisible ? 'open' : 'closed'}"
       aria-label="Sidenav">
            ...
            <li>
                <a href="/admin/returns"
                   class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">RMA's</span>
...
<button on:click={toggleSidebar}
        class="toggle-button inline-flex items-center p-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700"
...
<style>
    .toggle-button {
        ...
        z-index: 50; /* Ensure it's above the sidebar */
        transition: left 0.3s ease;
    }

    .sidebar {
        transition: transform 0.3s ease;
        width: 256px; /* Define the sidebar width */
    }
